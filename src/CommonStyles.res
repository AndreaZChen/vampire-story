...
global(. "hr", [borderColor(#hex(defaultBorderHex)), width(#percent(100.))])

global(. "body", [unsafe("scrollbar-width", string_of_int(scrollbarWidth) ++ "px")])

global(.
  "::-webkit-scrollbar-track:vertical",
  [
    boxShadow(
      Shadow.box(~x=#px(1), ~y=#px(0), ~blur=#px(1), ~spread=#px(0), ~inset=true, #hex("F6F6F6")),
    ),
    boxShadow(
      Shadow.box(~x=#px(-1), ~y=#px(0), ~blur=#px(1), ~spread=#px(0), ~inset=true, #hex("F6F6F6")),
    ),
...
global(.
  ...
  [
    ...
    boxShadow(
      Shadow.box(~x=#px(0), ~y=#px(1), ~blur=#px(1), ~spread=#px(0), ~inset=true, #hex("F6F6F6")),
    ),
    boxShadow(
      Shadow.box(~x=#px(0), ~y=#px(-1), ~blur=#px(1), ~spread=#px(0), ~inset=true, #hex("F6F6F6")),
    ),
...
global(.
  ...
  [
    ...
    boxShadow(Shadow.box(~x=#px(0), ~y=#px(0), ~blur=#px(1), #rgba(255, 255, 255, #num(0.5)))),
  ],
)

global(. "::-webkit-scrollbar-thumb:hover", [backgroundColor(#rgba(0, 0, 0, #num(0.5)))])
